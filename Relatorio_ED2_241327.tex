...
\begin{enumerate}
  ...
  \item A DRL agent trained with SB3 DQN over 50{,}000 synthetic steps using
    ...
    observing semantic rule types. We show analytically that this is the
    information-theoretic maximum for a binary-flag observation space---only
    the mandatory-discard cases are identifiable from one bit---so the figure
    bounds \emph{this observation space}, not DRL as a paradigm.
